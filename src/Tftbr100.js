...
const Tftbr100= () => {
    const [mainImage, setMainImage] = useState(foldingimg);
    ...
    return (
        ...
        <div className='features-container'>
            ...
            <div className='features-content'>
                <img src={foldingimg1} alt="Specifications" className="specifications-image"  /> 
