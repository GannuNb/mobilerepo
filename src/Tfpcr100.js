...
import foldingimg from "./images/tyre folding1.jpg"
import foldingimg1 from "./images/tyre folding2.jpg"



const Tfpcr100 = () => {
    const [mainImage, setMainImage] = useState(foldingimg1);
    ...
    const machinery = 'folding-machine'; 
    const model = 'TFPCR100';
    ...
    return (
        ...
        <div className='productpagetop'>
                ...
                <div className="additional-images">
                    <div>
                        <img 
                            ...
                            src={foldingimg} 
                            alt="Angle 1" 
                            onClick={() => handleImageClick(foldingimg)} 
                            onMouseEnter={() => handleImageHover(foldingimg)} 
                        />
                    </div>
                    <div>
                        <img 
                            ...
                            src={foldingimg1} 
                            alt="Angle 2" 
                            onClick={() => handleImageClick(foldingimg1)} 
                            onMouseEnter={() => handleImageHover(foldingimg1)} 
                        />
                    </div>
                    <div>
                        <img 
            ...
            <div className="productdetails">
                ...
                <p>
                    Our SHT-2000 is a high performance tyre shredder model, designed to efficiently process and recycle used/waste tyres with ease.
                    ...
                    this SHT 2000 can effectively reduce tyres into smaller and more manageable pieces, 
                    making them ready for further recycling or disposal. SHT-2000 operates with precision and speed, 
        ...
        <div className='features-container'>
            ...
            <div className='features-content'>
                <img src={foldingimg} alt="Specifications" className="specifications-image" /> 
